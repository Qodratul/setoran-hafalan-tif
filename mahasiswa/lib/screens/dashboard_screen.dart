...
class _DashboardScreenState extends State<DashboardScreen> with TickerProviderStateMixin {
  ...
  final double _fullscreenThreshold = 100.0;
  final double _exitFullscreenThreshold = 50.0;
          ...
          child: Column(
            children: [
              AnimatedCrossFade(
                ...
                crossFadeState: _isFullScreen ? CrossFadeState.showSecond : CrossFadeState.showFirst,
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        border: Border.all(color: progressColor.withValues(
                            alpha: 0.3)),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        ...
                        Colors.white.withValues(alpha: 0.3 * _pulseAnimation.value),
                        Colors.white.withValues(alpha: 0.1),
                      ],
                    ),
                  ),
                ...
                child: NotificationListener<ScrollNotification>(
                  onNotification: (ScrollNotification notification) {
                    if (notification is ScrollUpdateNotification) {
                      ...
                      if (scrollPixels > _fullscreenThreshold && !_isFullScreen) {
                        setState(() {
                          _isFullScreen = true;
                        });
                      }
                      else if (scrollPixels < _exitFullscreenThreshold && _isFullScreen) {
                        setState(() {
                          _isFullScreen = false;
                        });
                      }
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Cari surah yang mau di-muroja\'ah',
  ...
  Widget _buildTabBar() {
    return TabBar(
      ...
      tabs: const [
        Tab(text: 'Semua'),
        Tab(text: 'Belum di-muroja\'ah'),
        Tab(text: 'Sudah di-muroja\'ah'),
      ],
    );
  }
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          surah.sudahSetor ? 'Sudah di-muroja\'ah' : 'Belum di-muroja\'ah',
                          style: TextStyle(
                            fontSize: 12,
                            color: surah.sudahSetor ? Colors.green : Colors
                                .orange,
